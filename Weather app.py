...
def showWeather():
    ...
    api_key = "e7b5099e5f6abd30c205894ceebdf8f1"  #sample API
...
#assigning Values to our weather varaible, to display as output
        ...
        weather = f"\nWeather of: {city_name}\nTemperature of {city_name} (Celsius): {temp}°\nFeels like in {city_name}(Celsius): {feels_like_temp}°\nPressure in {city_name}: {pressure} hPa\nHumidity in {city_name}: {humidity}%\nCloud percentage in {city_name}: {cloudy}%\nDescription of {city_name}: {description}"
    else:
